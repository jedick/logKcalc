...
```{r Mosaic1, message = FALSE, fig.width = 12, fig.height = 10, out.width = "75%", fig.align = "center"}
source("As_mosaic.R")
```
...
```{r Mosaic2, fig.width = 24, fig.height = 12, out.width = "100%", out.extra='class="full-width"', message = FALSE}
par(mfrow = c(1, 2))
mosaicfun(FALSE)
mosaicfun(TRUE)
```
