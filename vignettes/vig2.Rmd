...
#### This vignette shows how to update a GWB thermodynamic data file using `r logK` values computed with the [OBIGT](../../CHNOSZ/doc/obigt.html) database in CHNOSZ.
...
Some species in the GWB data file may not be present in the default OBIGT database, but [optional databases](../../CHNOSZ/doc/obigt.html#optional-data) in CHNOSZ can also be used.
