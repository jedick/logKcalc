...
This depends on the parameters for As(OH)~3~ ([Perfetti et al., 2008](https://doi.org/10.1016/j.gca.2007.11.017)), which were added to OBIGT in CHNOSZ 1.4.0, so they are defined here if needed for an earlier version.
