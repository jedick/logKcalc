...
This depends on the parameters for As(OH)~3~ ([Perfetti et al., 2008](https://doi.org/10.1016/j.gca.2007.11.017)), which were added to OBIGT after CHNOSZ 1.3.6, so they are defined here if needed for an earlier version.

```{r addOBIGT, message = FALSE}
if(packageVersion("CHNOSZ") <= "1.3.6") mod.obigt("As(OH)3", E_units = "J",
