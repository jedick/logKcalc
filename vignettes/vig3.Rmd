---
title: "Changing T and P and adding species (gold solubility)"
output:
  html_vignette:
    mathjax: null
vignette: >
  %\VignetteIndexEntry{3 - Changing T and P and adding species (gold solubility)}
...
#### This vignette shows a worked example for gold solubility diagrams.
...
The thermodynamic system is defined by `thermo_12elements.tdat`, which is a modfied version of GWB's `thermo.tdat` file reduced to 12 elements.
