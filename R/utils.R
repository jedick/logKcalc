...
# Run berman or Berman depending on CHNOSZ version 20220209
Berman <- function(...) {
  if(utils::packageVersion("CHNOSZ") > "1.4.1") fun <- get("Berman", asNamespace("CHNOSZ"))
  else fun <- get("berman", asNamespace("CHNOSZ"))
  fun(...)
}
